...
The state equations have two cases : 
the boundary case and the general case.
...
we are actually converting word1[0..i - 2] to word2[0..j - 1], which costs dp[i - 1][j], 
